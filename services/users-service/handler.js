...
module.exports.registerUser = (event, context, callback) => {
  ...
  try {
    ...
    console.log("\n********** Event 'userCreated' emitted with data:" + JSON.stringify(savedUserData) + "\n**********\n");
  } catch (e) {
    console.log("\n********** ERROR: In emitting 'userCreated' event **********\n" + e + "\n**********\n");
  }
...
module.exports.getUser = (event, context, callback) => {
  ...
  var userData = {"user": {"id": 123, "name": "Rupak Ganguly", "email": `rupak@serverless.com`}};
